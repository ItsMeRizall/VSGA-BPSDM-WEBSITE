...
<body>
    <nav class="flex items-center border-b-2 px-6 py-4 border-black-500 sticky top-0 bg-white overflow-hidden z-50">
        ...
        <ul class="flex-1 text-center">
            <li class="inline-block px-5 list-none"><a href="about.html" class="no-underline text-black px-2">About</a></li>
            ...
            <li class="inline-block px-5 list-none"><a href="#" class="no-underline text-black px-2">Bussines</a></li>
    ...
    <div class="container p-5 min-h-screen">
      <div class="gambar">
            ...
            <div class="flex justify-between items-center ">
                <h2 class="text-2xl font-semibold">Bussines Update</h2>
            ...
            <?php
                    ...
                    $result = $dbHelper->getData("news", "*", "news_kategory = 'bussines'", "news_update DESC");
                    if (!empty($result)) {
                        $max;
                            if(count($result) > 6){
                                $max = 6;
